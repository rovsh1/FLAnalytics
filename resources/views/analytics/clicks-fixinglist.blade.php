    ...
    <div>
        ...
        <div>
            <div class="col-lg-12" >
                ...
                <hr>
                <h4>
                    Number of people who clicked on the contact - Goal ID 7 / Goal Set 2 "Clicking on the Contacts button (from the project and the wizard on the page)" (Goal 7 Completions) </h4>
                <div id="clicks-5-container" style="width:100%"></div>

                <hr>
                <h4>Number of registered - Goal ID 4 / Goal Set 1 Goal 4 Completions</h4>
                <div id="clicks-6-container" style="width:100%"></div>

                <hr>
                <hr>

                <h4>Сlick on the handset icon in the Goal ID 9 / Goal Set 2</h4>
                <div id="clicks-1-container" style="width:100%"></div>

                <hr>
                <h4>
                    Clicking on "View my projects" Goal ID 8 / Goal Set 2</h4>
                <div id="clicks-2-container" style="width:100%"></div>
                <hr>
                <h4>
                    Click - Login Goal ID 5 / Goal Set 1 (Goal 5 Completions)</h4>
                <div id="clicks-3-container" style="width:100%"></div>
                <hr>
                <h4>Click - registration Goal ID 1 / Goal Set 1 (Goal 1 Completions)</h4>
