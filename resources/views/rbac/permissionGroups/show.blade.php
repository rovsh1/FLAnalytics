            ...
            <div class="row">
              <div class="col-xs-6">
                <a href="/rbac/permissions/{{$model->id}}/edit" class="btn btn-small btn-info btn-block">
                  <i class="fa fa-pencil fa-fw" aria-hidden="true"></i> Edit<span class="hidden-xs hidden-sm"> this</span><span class="hidden-xs"> Group</span>
                </a>
              </div>
              {!! Form::open(array('url' => 'rbac/permission-groups/' . $model->id, 'class' => 'col-xs-6')) !!}
                {!! Form::hidden('_method', 'DELETE') !!}
                {!! Form::button('<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i> Delete<span class="hidden-xs hidden-sm"> this</span><span class="hidden-xs"> permission group</span>', array('class' => 'btn btn-danger btn-block btn-flat','type' => 'submit', 'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete permission group', 'data-message' => 'Are you sure you want to delete this permission group?')) !!}
              {!! Form::close() !!}
            </div>
          </div>
        </div>
